...
urlpatterns = [
    ...
    path(
        'grupos/<int:pk>/reactivar/',
        views.GrupoReactivarView.as_view(),
        name='grupo-reactivar',
    ),
    # clínicas
    ...
    path(
        'clinicas/<int:pk>/editar/',
        views.ClinicaUpdateView.as_view(),
        name='clinica-editar',
    ),
    path(
        'clinicas/<int:pk>/eliminar/',
        views.ClinicaBajaView.as_view(),
        name='clinica-eliminar',
    ),
    path(
        'clinicas/<int:pk>/reactivar/',
        views.ClinicaReactivarView.as_view(),
        name='clinica-reactivar',
    ),
    # especialidades
    ...
    path(
        ...
        views.EspecialidadDetalleView.as_view(),
    ...
    path(
        ...
        views.EspecialidadBajaView.as_view(),
        name='especialidad-eliminar',
    ),
    path(
        'especialidades/<int:pk>/reactivar/',
        views.EspecialidadReactivarView.as_view(),
        name='especialidad-reactivar',
    ),
]
