...
urlpatterns = [
    ...
    path(
        '<int:usuario_pk>/accesos/',
        views.UsuarioAccesosView.as_view(),
        name='usuario-accesos',
    ),
    path(
        '<int:usuario_pk>/accesos/nuevo/',
        views.UsuarioAccesoCrearView.as_view(),
        name='usuario-acceso-crear',
    ),
    path(
        '<int:usuario_pk>/accesos/<int:pk>/eliminar/',
        views.UsuarioAccesoEliminarView.as_view(),
        name='usuario-acceso-eliminar',
    ),
]
